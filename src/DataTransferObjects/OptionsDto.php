...
class OptionsDto
{
    ...
    public static function fromArray(array $options): OptionsDto
    {
        return new self(
            ...
            $options['cache_filename'] ?? config('domainparser.cache.file_name'),
            $options['cache_lifetime'] ?? config('domainparser.cache.life_time'),
    ...
    public static function fromConfig(): OptionsDto
    {
        return new self(
            ...
            config('domainparser.cache.file_name'),
            config('domainparser.cache.life_time'),
